...
export function sampleValueForField(field: DocField): string {
  ...
  const byName: Record<string, string | number | boolean> = {
    ...
    news_content: '近日，榆林市互联网信息办公室表示将持续完善数据汇聚与协同机制，推动重点领域数字化转型落地。',
...
function buildAlertDemoStandards(): Standard[] {
  const demo = [
    { orgId: 'o5', name: '清博智能西安高新教育舆情数据推送' },
    { orgId: 'o6', name: '清博智能韩川教体舆情数据推送' },
    { orgId: 'o7', name: '清博智能渭南农物联数据推送' },
    { orgId: 'o8', name: '清博智能西安经济智联数据推送' },
    { orgId: 'o9', name: '清博智能银川教科舆情数据推送' },
    { orgId: 'o10', name: '清博智能延安红网舆情数据推送' },
    { orgId: 'o11', name: '清博智能华山云巴生态数据推送' },
    { orgId: 'o12', name: '清博智能商洛康养物联数据推送' },
    { orgId: 'o13', name: '清博智能咸阳工门联数据推送' },
    { orgId: 'o14', name: '清博智能汉中新型政务数据推送' },
  ]
...
const seed = {
  orgCatalog: [
    { id: 'oc1', name: '榆林市互联网信息办公室', code: 'ORG_WXB_001' },
  ...
  orgs: [
    orgRecord({
      ...
      standardIds: ['st4', 'st09', 'st10', 'st11', 'st12', 'st13', 'st14'],
      remark: '',
      region: '榆林市/榆阳区',
      salesName: '张三三',
      openVersion: 'formal',
  ...
  standards: [
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '智慧星光榆林市机构舆情数据推送-接口文档.pdf',
      fileSize: '10 KB',
      fileUrl: '#',
    ...
    },
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '清博智能西安市委宣传部舆情数据推送-接口文档.pdf',
      fileSize: '11 KB',
      fileUrl: '#',
      status: 'enabled' as Status,
      uploader: '平台运营',
    ...
    },
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '数美科技榆林市舆情数据订阅-接口文档.pdf',
      fileSize: '9 KB',
      fileUrl: '#',
      status: 'enabled' as Status,
      uploader: '数据接入组',
    ...
    },
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '智慧星光西安市委宣传部宣传口径数据推送-接口文档.pdf',
      fileSize: '10 KB',
      fileUrl: '#',
      status: 'enabled' as Status,
      uploader: '平台运营',
    ...
    },
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '数美科技西安市委宣传部舆情批量数据接入-接口文档.pdf',
      fileSize: '8 KB',
      fileUrl: '#',
      status: 'enabled' as Status,
      uploader: '数据接入组',
    ...
    },
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '清博智能雁塔区融媒体舆情数据推送-接口文档.pdf',
      fileSize: '6 KB',
      fileUrl: '#',
      status: 'enabled' as Status,
      uploader: '平台运营',
    ...
    },
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '清博智能榆林市实时舆情数据推送-接口文档.pdf',
      fileSize: '12 KB',
      fileUrl: '#',
      status: 'enabled' as Status,
      uploader: '平台运营',
    ...
    },
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '智慧星光榆林市网信报送数据推送-接口文档.pdf',
      fileSize: '10 KB',
      fileUrl: '#',
      status: 'enabled' as Status,
      uploader: '平台运营',
    ...
    },
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '数美科技榆林市舆情库表增量数据投递-接口文档.pdf',
      fileSize: '11 KB',
      fileUrl: '#',
      status: 'enabled' as Status,
      uploader: '数据接入组',
    ...
    },
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '百度舆情榆林市舆情数据推送-接口文档.pdf',
      fileSize: '11 KB',
      fileUrl: '#',
      status: 'enabled' as Status,
      uploader: '平台运营',
    ...
    },
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '清博智能榆林市舆情高吞吐数据订阅-接口文档.pdf',
      fileSize: '9 KB',
      fileUrl: '#',
      status: 'enabled' as Status,
      uploader: '数据接入组',
    ...
    },
    {
      ...
      fileAccess: defaultFileAccess(),
      apiDocMarkdown: '',
      fileName: '智慧星光榆林市舆情文件批量投递-接口文档.pdf',
      fileSize: '8 KB',
      fileUrl: '#',
      status: 'enabled' as Status,
      uploader: '数据接入组',
